...
# colors
bg=$(get_tmux_option "@tmux-dotbar-bg" '#1e1e2e')
fg=$(get_tmux_option "@tmux-dotbar-fg" '#585b70')
fg_current=$(get_tmux_option "@tmux-dotbar-fg-current" '#cdd6f4')
fg_session=$(get_tmux_option "@tmux-dotbar-fg-session" '#9399b2')
fg_prefix=$(get_tmux_option "@tmux-dotbar-fg-prefix" '#cba6f7')
